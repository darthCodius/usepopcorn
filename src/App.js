...
export default function App() {
  ...
  function handleSelectMovie(id) {
    setSelectedId((curr_id) => (selectedId === id ? null : id));
  }
  ...
  function handleAddWatched(movie) {
    ...
    // localStorage.setItem("watched", JSON.stringify([...watched, movie])); here we were getting stale state hence it is better to do this under useEffect hook
  }
